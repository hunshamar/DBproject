...
public class Exercise {
	...
	public Exercise(String bodypart, String name, String description)
	{
	...
	public void CreateExerciseInDatabase()
	{
		try {
			Driver driver = new Driver();
			driver.myStat.executeUpdate("INSERT INTO Exercise VALUES (default, null ,'"+ 
			bodypart+"','"+ this.name +"','"+ this.description + "')", Statement.RETURN_GENERATED_KEYS);

			System.out.println("bodypart: " + this.bodypart);
		    ...
		    this.exerciseID = autoIncKeyFromApi;
			driver.myConn.close();
	...
	public void CreateExerciseInDatabase(int equipmentID)
	{
		try {
			Driver driver = new Driver();
			driver.myStat.executeUpdate("INSERT INTO Exercise VALUES (default,"+ equipmentID +",'"+ 
			bodypart+"','"+ this.name +"','"+ this.description + "')", Statement.RETURN_GENERATED_KEYS);
